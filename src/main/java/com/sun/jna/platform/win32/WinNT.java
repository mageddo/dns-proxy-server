...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD {
   ...
   * It is also used to indicate which, if any, privileges are held by a user or group requesting
   * access to an object.
   */
...
* @see
  ...
  public static class HANDLEByReference extends ByReference {
    ...
    public HANDLE getValue() {
      ...
      if (WinBase.INVALID_HANDLE_VALUE.getPointer()
          .equals(p)) {
        return WinBase.INVALID_HANDLE_VALUE;
      }
      HANDLE h = new HANDLE();
 ...
 , "szCSDVersion"})
  ...
  public static abstract class ACCESS_ACEStructure extends ACE_HEADER {
    ...
    public ACCESS_ACEStructure(int Mask, byte AceType, byte AceFlags, PSID psid) {
      ...
      this.psid = psid;
      this.Mask = Mask;
      this.SidStart = psid.getPointer()
          .getByteArray(0, SidStart.length);
  ...
  * object
  ...
  public static class SYSTEM_LOGICAL_PROCESSOR_INFORMATION extends Structure {
    /**
     * The processor mask identifying the processors described by this structure. A processor
     * mask is a bit
    ...
    public static class AnonymousUnionPayload extends Union {
      ...
      /**
       * <p>Identifies the characteristics of a particular cache. There is one record returned
       * for each cache
       * reported. Some or all caches may not be reported, depending on how caches are identified
       * . Therefore,
       ...
       *
       * <p>This member was not supported until Windows Server 2003 SP1 / Windows XP Professional
       * x64.</p>
       */
    ...
    public static class AnonymousStructProcessorCore extends Structure {
      /**
       * <p>If the value of this mmeber is {@code 1}, the logical processors identified by the
       * value of the
       * {@link #processorMask} member share functional units, as in Hyperthreading or SMT.
       * Otherwise, the
       * identified logical processors do not share functional units.</p>
       *
       * <p>Note: Prior to Windows Vista, this member is also {@code 1} for cores that share a
       * physical
       * package.</p>
       */
      public BYTE flags;
    ...
    public static class AnonymousStructNumaNode extends Structure {
      /**
       * Identifies the NUMA node. Valid values are {@code 0} to the highest NUMA node number
       * inclusive.
  ...
  public abstract class SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX extends Structure {
     ...
     *
     * @param memory A pointer to the allocated native memory.
     */
     ...
     * length arrays.
     *
     * @param memory A pointer to allocated memory to be cast to this class.
   ...
   * {@link SYSTEM_LOGICAL_PROCESSOR_INFORMATION} or
   * <code>SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX</code> structure.
   */
  public interface LOGICAL_PROCESSOR_RELATIONSHIP {
    ...
    /**
     * <p>The specified logical processors share a physical package (a single package socketed or
     * soldered onto a
     * motherboard may contain multiple processor cores or threads, each of which is treated as a
     * separate
    ...
    /**
     * <p>On input, retrieves information about all possible relation types. This value is not
     * used on output.</p>
     *
     * <p>Not supported until Windows Server 2008 R2.</p>
     */
  ...
  public static class CACHE_DESCRIPTOR extends Structure {
    /**
     * The cache level. This member can be 1, 2 or 3, corresponding to L1, L2 or L3 cache,
     * respectively (other
    ...
    /**
     * The cache associativity. If this member is {@link #CACHE_FULLY_ASSOCIATIVE}, the cache is
     * fully
     * associative.
     */
    public BYTE associativity;
   ...
   * {@link CACHE_DESCRIPTOR} structure.
   */
   ...
   */
  @FieldOrder(
      {"AcOnLine", "BatteryPresent", "Charging", "Discharging", "Spare1", "Tag", "MaxCapacity",
   ...
   */
  @FieldOrder(
      {"Revision", "PowerButton", "SleepButton", "LidClose", "LidOpenWake", "Reserved", "Idle",
          "IdleTimeout", "IdleSensitivity", "DynamicThrottle", "Spare2", "MinSleep", "MaxSleep",
          "ReducedLatencySleep", "WinLogonFlags", "Spare3", "DozeS4Timeout",
 ...
 "OverThrottled"})
  ...
  @FieldOrder(
      {"PowerButtonPresent", "SleepButtonPresent", "LidPresent", "SystemS1", "SystemS2", "SystemS3",
          ...
          , "UpsPresent",
          "ThermalControl", "ProcessorThrottle", "ProcessorMinThrottle", "ProcessorMaxThrottle",
          "FastSystemS4",
          "Hiberboot", "WakeAlarmPresent", "AoAc", "DiskSpinDown", "HiberFileType",
          "AoAcConnectivitySupported",
          "spare3", "SystemBatteriesPresent", "BatteriesAreShortTerm", "BatteryScale",
          "AcOnLineWake", "SoftLidWake",
   ...
   * For free pages, the information in the AllocationBase, AllocationProtect, Protect, and Type
 ...
 * access.
   ...
   *  </pre>
   *
   * <p>WARNING:  This pattern isn't always follows, Serbina, Bosnian &amp; Croation for example
   * .</p>
   *
  ...
  public static final int LANG_SYSTEM_DEFAULT = LocaleMacros.MAKELANGID(LANG_NEUTRAL,
      SUBLANG_SYS_DEFAULT
  );
  public static final int LANG_USER_DEFAULT = LocaleMacros.MAKELANGID(LANG_NEUTRAL,
      SUBLANG_DEFAULT
  );

  public static final LCID LOCALE_SYSTEM_DEFAULT = LocaleMacros.MAKELCID(LANG_SYSTEM_DEFAULT,
      SORT_DEFAULT
  );
  public static final LCID LOCALE_USER_DEFAULT = LocaleMacros.MAKELCID(LANG_USER_DEFAULT,
      SORT_DEFAULT
  );

  public static final LCID LOCALE_NEUTRAL = LocaleMacros.MAKELCID(
      LocaleMacros.MAKELANGID(LANG_NEUTRAL, SUBLANG_NEUTRAL), SORT_DEFAULT);

  public static final LCID LOCALE_INVARIANT = LocaleMacros.MAKELCID(
      LocaleMacros.MAKELANGID(LANG_INVARIANT, SUBLANG_NEUTRAL), SORT_DEFAULT);
