...
public interface Kernel32 extends StdCallLibrary, WinNT, Wincon {
   ...
   * {@code GetLastError}.
   * @see <A HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa366730(v=vs.85)
   * .aspx">LocalFree</A>
   */
   ...
   * {@code GetLastError}.
   * @see <A HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/aa366579(v=vs.85)
   * .aspx">GlobalFree</A>
   */
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724390(v=vs.85).aspx">GetSystemTime documentation</a>
   */
   ...
   * information.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724942(v=vs.85).aspx">SetSystemTime documentation</a>
   */
   ...
   *                     local date and time.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724338(v=vs.85).aspx">GetLocalTime documentation</a>
   */
   ...
   * information.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724936(v=vs.85).aspx">SetLocalTime documentation</a>
   */
   ...
   * information.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724400(v=vs.85).aspx">GetSystemTimes documentation</a>
   */
  boolean GetSystemTimes(WinBase.FILETIME lpIdleTime, WinBase.FILETIME lpKernelTime,
   ...
   *
   * @param hProcess              A handle to the process whose affinity mask is to be set. This
   ...
   * @param dwCompletionKey            The value to be returned through the lpCompletionKey
   *                                   parameter
   ...
   * @see <A HREF="https://msdn.microsoft.com/en-us/library/windows/desktop/ms724211(v=vs.85)
   * .aspx">CloseHandle</A>
   */
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364439(v=vs.85).aspx">FlushFileBuffers documentation</a>
   */
   ...
   *                        Namespaces.
   *                        <p>
   *                        <strong>Note</strong> Fast user switching is implemented using
   *                        Terminal Services
   ...
   *
   * @param dwDesiredAccess The access to the file mapping object. This access is checked
   ...
   * @param bInheritHandle  If this parameter is true, a process created by the CreateProcess
   *                        function can inherit the handle; otherwise,
   *                        the handle cannot be inherited.
   * @param lpName          The name of the file mapping object to be opened.
   ...
   *                  descriptor.</p>
   * @param fInherit  If this value is TRUE, processes created by this process will inherit the
   ...
   *                  1(WinNT.PROCESS_NAME_NATIVE) - The name should use the native system path
   *                  format.
   ...
   * call GetLastError.
   */
  boolean QueryFullProcessImageName(HANDLE hProcess, int dwFlags, char[] lpExeName,
   ...
   *
   * @param lpVersionInformation A pointer to an
   *                             {@link com.sun.jna.platform.win32.WinNT.OSVERSIONINFOEX} structure
   ...
   * @param dwTypeMask           A mask that indicates the members of the
   *                             {@link com.sun.jna.platform.win32.WinNT.OSVERSIONINFOEX}
   *                             structure to be tested.
   * @param dwlConditionMask     The type of comparison to be used for each
   *                             {@code lpVersionInfo} member being compared. To build this
   *                             value, call the {@link #VerSetConditionMask} function once for
   *                             each {@link com.sun.jna.platform.win32.WinNT.OSVERSIONINFOEX}
   ...
   * {@link WinError#ERROR_OLD_WIN_VERSION}.
   */
  boolean VerifyVersionInfoW(OSVERSIONINFOEX lpVersionInformation, int dwTypeMask,
   ...
   *
   * @param conditionMask A value to be passed as the {@code dwlConditionMask} parameter
   ...
   * @param typeMask      A mask that indicates the member of the
   *                      {@link com.sun.jna.platform.win32.WinNT.OSVERSIONINFOEX} structure
   *                      whose comparison
   *                      operator is being set. This value corresponds to one of the
   *                      bits specified in the {@code dwTypeMask} parameter for the
   *                      {@link #VerifyVersionInfoW} function.
   * @param condition     The operator to be used for the comparison. The
...
*                         {@link com.sun.jna.platform.win32.WinNT.LOGICAL_PROCESSOR_RELATIONSHIP#RelationAll}
   ...
   *                         are undefined.
   * @param returnedLength   On input, specifies the length of the buffer pointed to by
 ...
 DWORDByReference returnedLength);
   ...
   * @param FileInformationClass A FILE_INFO_BY_HANDLE_CLASS enumeration value that specifies the
   *                             type of
   *                             information to be retrieved.
   * @param lpFileInformation    A pointer to the buffer that receives the requested file
   *                             information.
   *                             The structure that is returned corresponds to the class that is
   *                             specified
   ...
   *                             Valid values are FILE_BASIC_INFO, FILE_RENAME_INFO,
   *                             FILE_DISPOSITION_INFO, FILE_ALLOCATION_INFO,
   *                             FILE_END_OF_FILE_INFO, and FILE_IO_PRIORITY_HINT_INFO
   * @param lpFileInformation    A pointer to the buffer that contains the information to change
   *                             for the specified file
   *                             information class. The structure that this parameter points to
   *                             corresponds to the class
   *                             that is specified by FileInformationClass.
   * @param dwBufferSize         The size of the lpFileInformation buffer, in bytes.
   * @return Returns nonzero if successful or zero otherwise. To get extended error information,
   * call GetLastError.
   */
  boolean SetFileInformationByHandle(HANDLE hFile, int FileInformationClass,
      Pointer lpFileInformation, DWORD dwBufferSize);
   ...
   *                                \\MyServer\MyShare\&quot;).
   *                                Furthermore, a drive specification must have a trailing
   *                                backslash
   ...
   * @param lpNumberOfFreeClusters  A variable that receives the total number of free clusters on
   *                                the
   ...
   * information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364935(v=vs.85).aspx">GetDiskFreeSpace</a>
   */
   ...
   *
   * @param lpDirectoryName          A string that specifies a directory on a disk. If this
   *                                 parameter
   *                                 is NULL, the function uses the root of the current disk. If
   *                                 this
   *                                 parameter is a UNC name, it must include a trailing backslash,
   *                                 for example,
   *                                 {@code \\MyServer\MyShare\}. This parameter does not have to
   *                                 specify
   ...
   * information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364937(v=vs.85).aspx">GetDiskFreeSpaceEx</a>
   */
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365144(v=vs.85).aspx">CallNamedPipe documentation</a>
   */
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365146(v=vs.85).aspx">ConnectNamedPipe documentation</a>
   */
   ...
   *                             </code>
   *                             </P>
   *                             <P>The <I>pipename</I> part of the name can include any
   *                             character other than a backslash,
   *                             including numbers and special characters. The entire pipe name
   *                             string can be up to
   *                             {@link #MAX_PIPE_NAME_LENGTH} characters long. Pipe names are
   ...
   *                             Acceptable values are in the range 1 through
   *                             {@link #PIPE_UNLIMITED_INSTANCES}
   ...
   *                             specifies a security descriptor for the new named pipe. If
   *                             {@code null} the named pipe
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365150(v=vs.85).aspx">CreateNamedPipe documentation</a>
   */
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365166(v=vs.85).aspx">DisconnectNamedPipe documentation</a>
   */
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365437(v=vs.85).aspx">GetNamedPipeClientComputerName documentation</a>
   */
  public boolean GetNamedPipeClientComputerName(HANDLE Pipe, char[] ClientComputerName,
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365440(v=vs.85).aspx">GetNamedPipeClientProcessId documentation</a>
   */
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365442(v=vs.85).aspx">GetNamedPipeClientProcessId documentation</a>
   */
   ...
   *                             state of the handle. This parameter can be {@code null} if this
   *                             information
   *                             is not needed.
  ...
  *                             this
   ...
   *                             before
   *                             transmission to the server. This parameter can be {@code null}
   *                             if this
   *                             information is not needed.
   ...
   *                             named pipe
   *                             transfers information over the network. This parameter can be
   *                             {@code null}
   ...
   *                             parameter. This parameter is ignored if <tt>lpUserName</tt> is
   *                             {@code null}.
   * @return {@code true} if successful, {@code false} otherwise.
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365443(v=vs.85).aspx">GetNamedPipeHandleState documentation</a>
   */
   ...
   *                        the buffer for incoming data, in bytes. This parameter can be {@code
   *                        null}
   *                        if this information is not needed.
   * @param lpMaxInstances  A pointer to a variable that receives the maximum
   *                        number of pipe instances that can be created. This parameter can be
   *                        {@code null}
   *                        if this information is not needed.
   * @return {@code true} if successful, {@code false} otherwise.
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365445(v=vs.85).aspx">GetNamedPipeInfo documentation</a>
   */
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365446(v=vs.85).aspx">GetNamedPipeServerProcessId documentation</a>
   */
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365569(v=vs.85).aspx">GetNamedPipeServerSessionId documentation</a>
   */
   ...
   *                               <tt>lpBuffer parameter</tt>, in bytes. This parameter is
   *                               ignored if
   *                               <tt>lpBuffer</tt> is {@code null}.
   * @param lpBytesRead            A variable that receives the number of bytes read
   *                               from the pipe. This parameter can be {@code null} if no data
   *                               is to be read.
   * @param lpTotalBytesAvail      A variable that receives the total number of
   *                               bytes available to be read from the pipe. This parameter can
   *                               be {@code null}
   *                               if no data is to be read.
   * @param lpBytesLeftThisMessage A variable that receives the number of
   *                               bytes remaining in this message. This parameter can be {@code
   *                               null}
   *                               if no data is to be read.
   * @return {@code true} if successful, {@code false} otherwise.
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365779(v=vs.85).aspx">PeekNamedPipe documentation</a>
   */
   ...
   *                             flag and a wait-mode flag. This parameter can be {@code null} if
   *                             the
   *                             mode is not being set.
   * @param lpMaxCollectionCount The maximum number of bytes collected on
   *                             the client computer before transmission to the server. This
   *                             parameter
   *                             can be {@code null} if the count is not being set.
   * @param lpCollectDataTimeout The maximum time, in milliseconds, that can
   *                             pass before a remote named pipe transfers information over the
   *                             network.
   *                             This parameter can be {@code null} if the timeout is not being set.
   * @return {@code true} if successful, {@code false} otherwise.
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365787(v=vs.85).aspx">SetNamedPipeHandleState documentation</a>
   */
   ...
   *                        include the name of the computer on which the server process is
   *                        executing.
   *                        The following pipe name format is used:
   *                        <P><code>
   *                        \\servername\pipe\pipename
   *                        </code></P>
   *                        <P>A period may be used for the <I>servername</I> if the pipe is
   *                        local.</P>
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms683187(v=vs.85).aspx">GetEnvironmentStrings documentation</a>
   */
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms683151(v=vs.85).aspx">FreeEnvironmentStrings documentation</a>
   */
  ...
  /**
   * Converts a file time to system time format. System time is based on Coordinated Universal
   * Time (UTC).
   *
   * @param lpFileTime   [in] A pointer to a FILETIME structure containing the file time to be
   ...
   */
  @Deprecated
  HANDLE CreateRemoteThread(HANDLE hProcess, WinBase.SECURITY_ATTRIBUTES lpThreadAttributes,
      int dwStackSize, FOREIGN_THREAD_START_ROUTINE lpStartAddress, Pointer lpParameter,
      DWORD dwCreationFlags, Pointer lpThreadId);
   ...
   *                           specifies a security descriptor for the new thread. If {@code null
   *                           }, the
   *                           thread gets a default security descriptor and the handle cannot be
   *                           inherited.
   * @param dwStackSize        The initial size of the stack, in bytes. The system rounds
   *                           this value to the nearest page. If this parameter is 0 (zero), the
   *                           new thread
   ...
   *                           to be executed by the thread and represents the starting address
   *                           of the
   *                           thread in the remote process. The function must exist in the
   *                           remote process.
   ...
   * error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms682437(v=vs.85).aspx">CreateRemoteThread documentation</a>
   */
  HANDLE CreateRemoteThread(HANDLE hProcess, SECURITY_ATTRIBUTES lpThreadAttributes,
      int dwStackSize, Pointer lpStartAddress, Pointer lpParameter, int dwCreationFlags,
   ...
   *                               transferred into the specified process.  If {@code null} the
   *                               parameter is ignored.
   * @return {@code true} if successful, {@code false} otherwise.
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms681674(v=vs.85).aspx">WriteProcessMemory documentation</a>
   */
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms680553(v=vs.85).aspx">MSDN</a>
   */
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa366907(v=vs.85).aspx">VirtualQueryEx documentation</a>
   */
  SIZE_T VirtualQueryEx(HANDLE hProcess, Pointer lpAddress, MEMORY_BASIC_INFORMATION lpBuffer,
      SIZE_T dwLength);
   ...
   *                     MS-DOS device, for example, {@code \Device\HarddiskVolume1} or {@code
   *                     \Device\Floppy0}.
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365461(v=vs.85).aspx">QueryDosDevice</a>
   */
   ...
   *
   * @param lpFileName     The directory or path, and the file name. The file name can include
   *                       wildcard characters,
   *                       for example, an asterisk (*) or a question mark (?).
   *                       This parameter should not be NULL, an invalid string (for example, an
   *                       empty string or a string that is
   *                       missing the terminating null character), or end in a trailing
   *                       backslash (\).
   *                       If the string ends with a wildcard, period, or directory name, the
   *                       user must have access to the root
   *                       and all subdirectories on the path.
   *                       In the ANSI version of this function, the name is limited to MAX_PATH
   *                       characters. To extend this
   *                       limit to approximately 32,000 wide characters, call the Unicode
   *                       version of the function (FindFirstFileExW),
   *                       and prepend "\\?\" to the path. For more information, see Naming a File.
   *                       <b>Tip</b> Starting in Windows 10, version 1607, for the unicode
   *                       version of this function (FindFirstFileExW),
   *                       you can opt-in to remove the MAX_PATH character limitation without
   *                       prepending "\\?\".
   *                       See the "Maximum Path Limitation" section of Naming Files, Paths, and
   *                       Namespaces for details.
   * @param lpFindFileData A pointer to the buffer that receives the file data. The pointer type
   ...
   * call to FindNextFile or FindClose,
   ...
   * If the function fails because no matching files can be found, the GetLastError function
   ...
   *                          an empty string or a string that is
   *                          missing the terminating null character), or end in a trailing
   *                          backslash (\).
   *                          If the string ends with a wildcard, period, or directory name, the
   *                          user must have access to the root
   ...
   *                          MAX_PATH characters. To extend this
   *                          limit to approximately 32,000 wide characters, call the Unicode
   *                          version of the function (FindFirstFileExW),
   *                          and prepend "\\?\" to the path. For more information, see Naming a
   *                          File.
   *                          <b>Tip</b> Starting in Windows 10, version 1607, for the unicode
   *                          version of this function (FindFirstFileExW),
   *                          you can opt-in to remove the MAX_PATH character limitation without
   *                          prepending "\\?\".
   *                          See the "Maximum Path Limitation" section of Naming Files, Paths,
   *                          and Namespaces for details.
   * @param fInfoLevelId      The information level of the returned data. This parameter is one
   *                          of the FINDEX_INFO_LEVELS enumeration values.
   * @param lpFindFileData    A pointer to the buffer that receives the file data. The pointer
   *                          type is determined by the level of
   *                          information that is specified in the fInfoLevelId parameter.
   * @param fSearchOp         The type of filtering to perform that is different from wildcard
   *                          matching. This parameter is one of
   *                          the FINDEX_SEARCH_OPS enumeration values.
   * @param lpSearchFilter    A pointer to the search criteria if the specified fSearchOp needs
   *                          structured search information.
   *                          At this time, none of the supported fSearchOp values require
   *                          extended search information. Therefore,
   ...
   *                          FIND_FIRST_EX_LARGE_FETCH (0x02) - Uses a larger buffer for
   *                          directory queries, which can increase performance
   *                          of the find operation. <b>Windows Server 2008, Windows Vista,
   *                          Windows Server 2003 and Windows XP:  This value
   ...
   * returns ERROR_FILE_NOT_FOUND.
   */
  HANDLE FindFirstFileEx(String lpFileName, int fInfoLevelId, Pointer lpFindFileData,
      int fSearchOp, Pointer lpSearchFilter, DWORD dwAdditionalFlags);

  /**
   * Continues a file search from a previous call to the FindFirstFile, FindFirstFileEx, or
   * FindFirstFileTransacted functions.
   *
   * @param hFindFile      The search handle returned by a previous call to the FindFirstFile or
   *                       FindFirstFileEx function.
   * @param lpFindFileData A pointer to the WIN32_FIND_DATA structure that receives information
  ...
  * is zero and the
   ...
   * To get extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364426(v=vs.85).aspx">FindFirstVolumeMountPoint</a>
   */
  HANDLE FindFirstVolumeMountPoint(String lpszRootPathName, char[] lpszVolumeMountPoint,
      int cchBufferLength);
   ...
   *                              {@link #FindFirstVolumeMountPoint(String, char[], int)}
   *                              function.
   ...
   */
  boolean FindNextVolumeMountPoint(HANDLE hFindVolumeMountPoint, char[] lpszVolumeMountPoint,
      int cchBufferLength);
 ...
 * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364435(v=vs.85).aspx">FindVolumeMountPointClose</a>
   ...
   *                             folder (e.g., &quot;Y:\MountX\&quot;) or a drive letter (for
   *                             example,
   *                             &quot;X:\&quot;). The string must end with a trailing backslash.
   * @param lpszVolumeName       A buffer that receives the volume GUID path - if
   *                             there is more than one volume GUID path for the volume, only the
   *                             first
   *                             one in the mount manager's cache is returned.
   * @param cchBufferLength      The length of the output buffer - a reasonable size
   *                             for the buffer to accommodate the largest possible volume GUID
   *                             path is
   *                             at 50 characters
   * @return {@code true} if succeeds. If fails then call {@link #GetLastError()}
   * to get extended error information
   * @see
  * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364994(v=vs.85).aspx">GetVolumeNameForVolumeMountPoint</a>
   */
  boolean GetVolumeNameForVolumeMountPoint(String lpszVolumeMountPoint, char[] lpszVolumeName,
      int cchBufferLength);
   ...
   *                       example, {@code Y:\MountX\}). The string must end with a trailing
   *                       backslash.
   ...
   *                       the function deletes any existing label from the specified volume and
   *                       does
   *                       not assign a new label.
   * @return {@code true} if succeeds. If fails then call {@link #GetLastError()}
   * to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365560(v=vs.85).aspx">SetVolumeLabel</a>
   */
   ...
   *                             volume. This may be a drive letter (for example, &quot;X:\&quot;
   *                             ) or a
   *                             directory on another volume (for example, &quot;Y:\MountX\&quot;
   *                             ). The
   ...
   * to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365561(v=vs.85).aspx">SetVolumeMountPoint</a>
   */
   ...
   *                             A trailing backslash is required, for example, &quot;X:\&quot;
   *                             or &quot;Y:\MountX\&quot;.
   * @return {@code true} if succeeds. If fails then call {@link #GetLastError()}
   * to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa363927(v=vs.85).aspx">DeleteVolumeMountPoint</a>
   */
   ...
   *                                 volume to be described. If this parameter is {@code null},
   *                                 the root of
   *                                 the current directory is used. A trailing backslash is
   *                                 required. For example,
   *                                 you specify &quot;\\MyServer\MyShare\&quot;, or &quot;
   *                                 C:\&quot;.
   ...
   *                                 component that the underlying file system supports - can be
   *                                 {@code null}
   ...
   *                                 of the file system. The buffer size is specified by the
   *                                 <tt>nFileSystemNameSize</tt>
   *                                 parameter.
   * @param nFileSystemNameSize      The length of the file system name buffer -
   *                                 max. size is {@link WinDef#MAX_PATH} + 1 - ignored if no
   *                                 file system name
   *                                 buffer provided
   * @return {@code true} if succeeds. If fails then call {@link #GetLastError()}
   * to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364993(v=vs.85).aspx">GetVolumeInformation</a>
   */
   ...
   *                           file and directory names, for example &quot;..&quot;, are
   *                           acceptable in
   *                           this path. If you specify a relative directory or file name without a
   *                           volume qualifier, returns the drive letter of the boot volume. If
   *                           this
   *                           parameter is an empty string, the function fails but the last
   *                           error is
   ...
   * to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364996(v=vs.85).aspx">GetVolumePathName</a>
   */
   ...
   *                            letters and mounted folder paths. The list is an array of
   *                            null-terminated
   *                            strings terminated by an additional NULL character. If the buffer is
   *                            not large enough to hold the complete list, the buffer holds as
   *                            much of
   ...
   *                            number of character copied to the buffer. Otherwise, this
   *                            parameter is the
   ...
   * used in a subsequent call to the
   * {@link #FindNextVolume(com.sun.jna.platform.win32.WinNT.HANDLE, char[], int)}
   ...
   * extended error information, call {@link #GetLastError()}.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa364425(v=vs.85).aspx">FindFirstVolume</a>
   ...
   * process.<br>
   * <br>
   * <pre><code>BOOL ProcessIdToSessionId(_In_ DWORD dwProcessId, _Out_ DWORD *pSessionId);
   * </code></pre><br>
   *
   ...
   *                   For more information about paths, see "Naming Files, Paths, and
   *                   Namespaces" on MSDN. <br>
   ...
   * information, call GetLastError.
   */
  boolean EnumResourceNames(HMODULE hModule, Pointer type, WinBase.EnumResNameProc proc,
      Pointer lParam);
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms684218(v=vs.85).aspx">MSDN</a>
   */
   ...
   * not contain module information.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms684221(v=vs.85).aspx">MSDN</a>
   */
  ...
  * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms680621(v=vs.85).aspx">MSDN</a>
   ...
   *
   * @param hProcess       A handle to the process whose timing information is sought.
   *                       The handle must have the PROCESS_QUERY_INFORMATION or
   *                       PROCESS_QUERY_LIMITED_INFORMATION access right.
   * @param lpCreationTime A pointer to a FILETIME structure that receives the creation
   *                       time of the process.
   * @param lpExitTime     A pointer to a FILETIME structure that receives the exit time
   *                       of the process. If the process has not exited, the content of
   *                       this structure is undefined.
   * @param lpKernelTime   A pointer to a FILETIME structure that receives the amount of
   ...
   * @param lpUserTime     A pointer to a FILETIME structure that receives the amount of
   ...
   *                     access right.
   * @param lpIoCounters A pointer to an IO_COUNTERS structure that receives the I/O
   ...
   *
   * @param lpMutexAttributes A pointer to a {@link WinBase.SECURITY_ATTRIBUTES} structure. If this
   ...
   *                          the creator.</p>
   * @param bInitialOwner     If this value is TRUE and the caller created the mutex, the calling
   ...
   * @param lpName            The name of the mutex object. The name is limited to
   ...
   *                          function requests the {@link WinBase#MUTEX_ALL_ACCESS} access right
   *                          . In
   *                          this case, the bInitialOwner parameter is ignored because it has
   *                          already
   *                          been set by the creating process. If the lpMutexAttributes
   *                          parameter is
   ...
   *                          {@link WinError#ERROR_INVALID_HANDLE}. This occurs because these
   *                          objects
   ...
   *                        the
   *                        handle. Otherwise, the processes do not inherit this handle.
   * @param lpName          The name of the mutex to be opened. Name comparisons are case sensitive.
   *
   *                        <p>
   ...
   *
   * @param handle A handle to the mutex object. The CreateMutex or OpenMutex function
   *               returns this handle.
   * @return If the function succeeds, the return value is nonzero.
   *
   * <p>If the function fails, the return value is zero. To get extended error
   ...
   *
   *                         <p>
   *                         If you are reserving memory, the function rounds this address down
   *                         to the
   ...
   *                         the enclave at that address. The page must be previously
   *                         uncommitted, and
   ...
   *                         straddles a page boundary causes the function to allocate both pages
   *                         .</p>
   ...
   *                       it for you.
   *
   *                       <p>If this parameter is NULL or an empty string, the previously
   *                       registered
   ...
   *                       </tr>
   *                       <tr><td>RESTART_NO_CRASH (1)</td><td>Do not restart the process if it
   *                       terminates due to an unhandled exception.</td></tr>
   *                       <tr><td>RESTART_NO_HANG (2)</td><td>Do not restart the process if it
   *                       terminates due to the application not responding.</td></tr>
   *                       <tr><td>RESTART_NO_PATCH (4)</td><td>Do not restart the process if it
   *                       terminates due to the installation of an update.</td></tr>
   *                       <tr><td>RESTART_NO_REBOOT (8)</td><td>Do not restart the process if
   *                       the computer is restarted as the result of an update. </td></tr>
   *                       </table>
   ...
   * -registerapplicationrestart">MSDN Entry</A>
   */
   ...
   * </table>
   * @see <A HREF="https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase
   * -unregisterapplicationrestart">MSDN Entry</A>
   */
