...
public interface Wincon {
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms681944(v=vs.85).aspx">AllocConsole documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms683150(v=vs.85).aspx">FreeConsole documentation</a>
   */
  boolean FreeConsole();
   ...
   *                    be used. Can be either the process ID or the special
   *                    {@link #ATTACH_PARENT_PROCESS}
   *                    value to indicate the console of the parent of the current process.
   * @return {@code true} if successful - if {@code false} then use
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms681952(v=vs.85).aspx">AttachConsole documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms683147(v=vs.85).aspx">FlushConsoleInputBuffer documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms683155(v=vs.85).aspx">GenerateConsoleCtrlEvent documentation</a>
   */
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/dd317756(v=vs.85).aspx">Code page identifiers</a>
   */
  int GetConsoleCP();
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms686013(v=vs.85).aspx">SetConsoleCP documentation</a>
   */
  ...
  /**
   * @param wCodePageID The output code page used by the console associated with the calling
   *                    process.
   * @return {@code true} if successful - if {@code false} then use
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms686036(v=vs.85).aspx">SetConsoleOutputCP documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms683207(v=vs.85).aspx">GetNumberOfConsoleInputEvents documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms683208(v=vs.85).aspx">GetNumberOfConsoleMouseButtons documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms686244(v=vs.85).aspx">SetStdHandle documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms683164(v=vs.85).aspx">GetConsoleDisplayMode documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms683167.aspx">GetConsoleMode documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms686033.aspx">SetConsoleMode documentation</a>
   */
   ...
   *                       string containing the title. If the buffer is too small to store the
   *                       title,
   *                       the function stores as many characters of the title as will fit in the
   *                       buffer,
   *                       ending with a null terminator. <B>Note:</B> use
   *                       {@link Native#toString(char[])}
   ...
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms683174(v=vs.85).aspx">GetConsoleTitle documentation</a>
   */
  int GetConsoleTitle(char[] lpConsoleTitle, int nSize);

  /**
   * @param lpConsoleTitle A pointer to a buffer that receives a null-terminated
   *                       string containing the original title. <B>Note:</B> use
   *                       {@link Native#toString(char[])}
   *                       to convert it to a {@link String} value
   ...
   * and {@code GetLastError} returns the error code.
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms683168(v=vs.85).aspx">GetConsoleOriginalTitle documentation</a>
   */
   ...
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/ms686050(v=vs.85).aspx">SetConsoleTitle documentation</a>
   */
   ...
   * @param lpConsoleScreenBufferInfo A pointer to a CONSOLE_SCREEN_BUFFER_INFO structure that
   *                                  receives the console screen buffer information.
   * @return {@code true} if successful - if {@code false} then use
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://docs.microsoft.com/en-us/windows/console/getconsolescreenbufferinfo">GetConsoleScreenBufferInfo documentation</a>
   */
  boolean GetConsoleScreenBufferInfo(HANDLE hConsoleOutput,
   ...
   * @param lpBuffer             A pointer to an array of INPUT_RECORD structures that receives
   *                             the input buffer data.
   * @param nLength              The size of the array pointed to by the lpBuffer parameter, in
   *                             array elements.
   * @param lpNumberOfEventsRead A pointer to a variable that receives the number of input
   *                             records read.
   * @return {@code true} if successful - if {@code false} then use
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://docs.microsoft.com/en-us/windows/console/readconsoleinput">ReadConsoleInput documentation</a>
   */
   ...
   *
   * @param hConsoleOutput         A handle to the console screen buffer.
   * @param lpBuffer               A pointer to a buffer that contains characters to be written
   *                               to the console screen buffer.
   * @param nNumberOfCharsToWrite  The number of characters to be written.
   * @param lpNumberOfCharsWritten A pointer to a variable that receives the number of characters
   *                               actually written.
   * @param lpReserved             Reserved; must be NULL.
   * @return {@code true} if successful - if {@code false} then use
   * {@code GetLastError()} to get extended error information
   * @see
   * <a href="https://docs.microsoft.com/en-us/windows/console/writeconsole">WriteConsole documentation</a>
   */
  ...
  public static class CONSOLE_SCREEN_BUFFER_INFO extends Structure {
    ...
    @Override
    public String toString() {
      return String.format("CONSOLE_SCREEN_BUFFER_INFO(%s,%s,%s,%s,%s)", dwSize, dwCursorPosition,
          wAttributes, srWindow, dwMaximumWindowSize
      );
    }
  }
   ...
   */
  @FieldOrder(
      {"bKeyDown", "wRepeatCount", "wVirtualKeyCode", "wVirtualScanCode", "uChar",
          "dwControlKeyState"})
  public static class KEY_EVENT_RECORD extends Structure {
    ...
    @Override
    public String toString() {
      return String.format("KEY_EVENT_RECORD(%s,%s,%s,%s,%s,%s)", bKeyDown, wRepeatCount,
          wVirtualKeyCode, wVirtualKeyCode, wVirtualScanCode, uChar, dwControlKeyState
      );
    }
  }
  ...
  public static class MOUSE_EVENT_RECORD extends Structure {
    ...
    @Override
    public String toString() {
      return String.format("MOUSE_EVENT_RECORD(%s,%s,%s,%s)", dwMousePosition, dwButtonState,
