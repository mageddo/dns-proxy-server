...
public interface Tlhelp32 {
  ...
  /**
   * Includes all heaps of the process specified in th32ProcessID in the snapshot. To enumerate
   * the heaps, see
   * Heap32ListFirst.
   */
   ...
   *
   * @see
   * <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms682489(v=vs.85).aspx">MSDN</a>
   */
  WinDef.DWORD TH32CS_SNAPMODULE = new WinDef.DWORD(0x00000008);

  /**
   * Includes all 32-bit modules of the process specified in th32ProcessID in the snapshot when
   * called from a 64-bit
   * process. This flag can be combined with TH32CS_SNAPMODULE or TH32CS_SNAPALL. If the function
   * fails with
  ...
  /**
   * Includes all processes and threads in the system, plus the heaps and modules of the process
  ...
  /**
   * Describes an entry from a list of the processes residing in the system address space when a
   * snapshot was taken.
   */
  ...
  public static class PROCESSENTRY32 extends Structure {
     ...
     * executable file, call the
     * Module32First function and check the szExePath member of the MODULEENTRY32 structure that
     * is returned.
   ...
   */
  @FieldOrder(
      {"dwSize", "cntUsage", "th32ThreadID", "th32OwnerProcessID", "tpBasePri", "tpDeltaPri",
          "dwFlags"})
